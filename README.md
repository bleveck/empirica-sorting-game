...
This repo is an [Empirica](https://empirica.ly/) v2 experiment (`@empirica/core@1.12.5` — the package is numbered 1.x even though it's the rewritten v2 of the platform).
